...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #0f766e 0%, #0d9488 50%, #14b8a6 100%); color: #ffffff; padding: 40px 32px; text-align: center; }
        ...
        .password-value { font-size: 18px; font-weight: 800; color: #0f766e; letter-spacing: 0.1em; background: #f0fdfa; padding: 4px 12px; border-radius: 6px; border: 1px solid #ccfbf1; }
        .warning-box { background: #fffbeb; border: 1px solid #fde68a; border-radius: 10px; padding: 16px; margin-bottom: 24px; display: flex; gap: 12px; align-items: flex-start; }
        .warning-icon { width: 24px; height: 24px; background: #fbbf24; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: 800; color: #78350f; flex-shrink: 0; }
        .warning-text { font-size: 13px; color: #92400e; font-weight: 500; line-height: 1.5; }
        ...
        .step-number { width: 24px; height: 24px; background: #0f766e; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 800; color: white; flex-shrink: 0; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="greeting">Hello {{ $riderName }},</p>
            <p class="intro">
                Your rider account for the Maki POS Delivery System has been created by the administrator. 
                Below are your login credentials to access the Rider Mobile App.
            </p>
            ...
            <div class="credentials-box">
                ...
                <div class="credential-row">
                    ...
                    <span class="credential-value">{{ $riderEmail }}</span>
                </div>
                <div class="credential-row">
            ...
            <div class="steps">
                ...
                <div class="step">
                    ...
                    <div class="step-text">Download and open the Rider Mobile App</div>
                </div>
                <div class="step">
                    <div class="step-number">2</div>
                    <div class="step-text">Enter your email and password shown above</div>
                </div>
                <div class="step">
                    <div class="step-number">3</div>
                    <div class="step-text">Set your status to <strong>"Available"</strong> to start receiving delivery orders</div>
                </div>
            </div>
        </div>

        <div class="footer">
            <p class="brand">Maki POS — Delivery System</p>
            <p>This is an automated email sent upon account creation. Please do not reply.</p>
