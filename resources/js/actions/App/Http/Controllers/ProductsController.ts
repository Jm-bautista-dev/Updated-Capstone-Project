 ...
 * @see app/Http/Controllers/ProductsController.php:113
 * @route '/products'
 */
 ...
 * @see app/Http/Controllers/ProductsController.php:235
 * @route '/products/{id}'
 */
 ...
 * @see app/Http/Controllers/ProductsController.php:330
 * @route '/products/{id}'
 */
...
const ProductsController = { store, update, destroy, index }
