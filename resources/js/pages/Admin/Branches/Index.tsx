                ...
                >
                        ...
                        <div>
                            ...
                            <div className="relative mt-1">
                                ...
                                <input
                                    ...
                                    placeholder="Lat"
                                    className="w-full h-11 rounded-xl border bg-muted/20 pl-9 pr-4 text-sm focus:ring-2 focus:ring-primary/30"
                                />
                            </div>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full min-h-[70px] p-3 rounded-xl border bg-muted/20 text-sm resize-none"
                    ...
                    <div className="border-t pt-4 space-y-4">
                        <div className="grid grid-cols-3 gap-3">
                            <div>
                                ...
                                <input type="number" value={data.delivery_radius_km} onChange={e => setData('delivery_radius_km', e.target.value)} className="mt-1 w-full h-9 rounded-lg border bg-muted/10 px-3 text-xs" />
                            </div>
                            <div>
                                <label className="text-[9px] font-bold text-muted-foreground uppercase">Base Fee (₱)</label>
                                <input type="number" value={data.base_delivery_fee} onChange={e => setData('base_delivery_fee', e.target.value)} className="mt-1 w-full h-9 rounded-lg border bg-muted/10 px-3 text-xs" />
                            </div>
                            <div>
                                <label className="text-[9px] font-bold text-muted-foreground uppercase">KM Fee (₱)</label>
                                <input type="number" value={data.per_km_fee} onChange={e => setData('per_km_fee', e.target.value)} className="mt-1 w-full h-9 rounded-lg border bg-muted/10 px-3 text-xs" />
                            </div>
                        </div>
                        <button
                            type="button"
                    ...
                    <div className="pt-2">
                        <button
                            type="submit"
                            disabled={processing}
                            className="w-full h-11 rounded-xl bg-primary text-primary-foreground font-black text-sm hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                            <Save className="size-4" />
                            {processing ? 'SYNCING...' : 'SAVE CHANGES'}
                        </button>
                    </div>
                </form>
