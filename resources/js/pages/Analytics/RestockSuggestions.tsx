...
export default function RestockSuggestions() {
 ...
 className={cn('group transition-colors hover:bg-muted/20 :bg-muted/40', cfg.rowCls)}
 >
 {/* Ingredient */}
 <td className="px-6 py-4">
 <div className="flex items-center gap-3">
 <div className="relative">
 <div className="size-9 rounded-xl bg-muted flex items-center justify-center font-black text-xs text-foreground">
 {s.name.charAt(0).toUpperCase()}
 </div>
 <div className={cn('absolute -bottom-0.5 -right-0.5 size-2.5 rounded-full border-2 border-background', cfg.dotCls)} />
 </div>
 <div>
 <p className="font-black text-sm text-foreground leading-tight">{s.name}</p>
 ...
 <Badge variant="outline" className="font-black text-[10px] border-border bg-background">
 ...
 {trendIcon(s.trend)}
 <span className="text-[10px] font-black text-foreground capitalize">{s.trend}</span>
 </div>
 <Badge className="bg-muted text-muted-foreground border-none font-black text-[9px]">
