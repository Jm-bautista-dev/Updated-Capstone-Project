import { Bike, Building2, Edit2, Mail, Phone, ShieldCheck, Trash2 } from 'lucide-react';
...
export function RiderDrawer({ rider, open, onOpenChange, onEdit, onDelete }: RiderDrawerProps) {
                ...
                <div className="relative p-6 bg-linear-to-br from-[#FFF5F7] via-[#FFF0F5] to-white dark:from-[#181820] dark:via-[#14141E] dark:to-[#0F0F14] border-b border-[#F8C8DC]/60 dark:border-white/10 space-y-4">
                    <SheetHeader className="text-left space-y-1">
                        ...
                        <SheetDescription className="text-xs text-[#7D6B6E] dark:text-[#94A3B8] font-medium">
                            Internal delivery fleet member & performance overview.
                        </SheetDescription>
                    </SheetHeader>
                    ...
                    <div className="flex items-center gap-4 pt-2">
                        ...
                        <div className="space-y-1 min-w-0">
                            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-white/80 dark:bg-[#181820] border border-[#F8C8DC]/60 dark:border-white/10 text-xs font-bold">
                                ...
                                <span>{rider.branch?.name || 'Unassigned Branch'}</span>
                            </div>
                            <p className="text-xs text-[#9E8B8E] dark:text-[#64748B] font-mono truncate">
                                Registered ID: #{rider.id}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="rounded-2xl bg-white/80 dark:bg-[#181820]/80 border border-[#F8C8DC]/60 dark:border-white/10 p-4 space-y-3.5 shadow-2xs">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-[#7D6B6E] dark:text-[#94A3B8]">Email / Username</p>
                                    <p className="text-xs font-bold font-mono text-[#3D2C2E] dark:text-[#F8FAFC]">{rider.email}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 pt-2 border-t border-[#F8C8DC]/30 dark:border-white/10">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-[#7D6B6E] dark:text-[#94A3B8]">Mobile Number</p>
                                    <p className="text-xs font-bold font-mono text-[#3D2C2E] dark:text-[#F8FAFC]">{rider.phone || 'No phone recorded'}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 pt-2 border-t border-[#F8C8DC]/30 dark:border-white/10">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-[#7D6B6E] dark:text-[#94A3B8]">Account Status</p>
                                    <p className="text-xs font-bold text-[#3D2C2E] dark:text-[#F8FAFC]">
                                        {rider.is_active ? 'Active & Authorized' : 'Suspended / Inactive'}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="rounded-2xl bg-white/80 dark:bg-[#181820]/80 border border-[#F8C8DC]/60 dark:border-white/10 p-4 flex items-center justify-between gap-4 shadow-2xs">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-bold uppercase tracking-wider text-[#7D6B6E] dark:text-[#94A3B8]">Total Deliveries</p>
                                    <p className="text-sm font-medium text-[#9E8B8E] dark:text-[#64748B]">Fulfilled orders</p>
                                </div>
                            </div>
                            <span className="font-mono font-black text-2xl text-[#E75480] dark:text-[#FF4F81]">
