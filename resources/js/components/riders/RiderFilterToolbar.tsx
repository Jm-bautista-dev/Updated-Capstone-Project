...
interface RiderFilterToolbarProps {
    search: string;
...
export function RiderFilterToolbar({
    search,
    onSearchChange,
    onSearchSubmit,
    filterStatus,
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Select value={filterStatus || 'all'} onValueChange={onStatusChange}>
                        ...
                        <SelectContent className="rounded-2xl border-[#F8C8DC]/60 dark:border-white/10 shadow-xl p-2 bg-white dark:bg-[#181820] text-[#3D2C2E] dark:text-[#E2E8F0]">
                            ...
                            <SelectItem value="available" className="rounded-xl font-bold text-xs uppercase tracking-wider py-2 text-emerald-600 dark:text-emerald-400 cursor-pointer dark:focus:bg-white/10">
                                Available
                            </SelectItem>
                            <SelectItem value="busy" className="rounded-xl font-bold text-xs uppercase tracking-wider py-2 text-amber-600 dark:text-amber-400 cursor-pointer dark:focus:bg-white/10">
                                On Delivery
                            </SelectItem>
                            <SelectItem value="offline" className="rounded-xl font-bold text-xs uppercase tracking-wider py-2 text-slate-600 dark:text-slate-400 cursor-pointer dark:focus:bg-white/10">
                                Offline
                            </SelectItem>
                        </SelectContent>
                    </Select>
