...
import { Building2, Plus, Shield, Sparkles, UserCheck, Users } from 'lucide-react';
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
                <div className="space-y-2">
                    ...
                    <p className="text-sm sm:text-base text-[#7D6B6E] dark:text-[#94A3B8] font-medium max-w-xl">
                        Configure staff authorizations, manage branch assignments, issue system keys, and monitor access levels.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 relative z-10 pt-2">
                ...
                >
                    ...
                    <div>
                        <p className="text-xs font-bold uppercase tracking-wider text-[#7D6B6E] dark:text-[#94A3B8]">Total Members</p>
                        <h3 className="text-2xl font-black text-[#3D2C2E] dark:text-[#F8FAFC] font-mono mt-0.5">{stats.total}</h3>
                        <p className="text-[11px] text-[#9E8B8E] dark:text-[#64748B]">Active workforce count</p>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="p-5 rounded-2xl bg-white/80 dark:bg-[#181820]/80 border border-[#F8C8DC]/50 dark:border-white/10 shadow-xs backdrop-blur-xl flex items-center gap-4 transition-all"
                >
                    <div className="p-3 rounded-2xl bg-[#E75480]/10 dark:bg-[#E1062C]/15 text-[#E75480] dark:text-[#FF4F81] shrink-0">
                ...
                >
                    ...
                    <div>
                        <p className="text-xs font-bold uppercase tracking-wider text-[#7D6B6E] dark:text-[#94A3B8]">Frontline Staff</p>
                        <h3 className="text-2xl font-black text-blue-600 dark:text-blue-400 font-mono mt-0.5">{stats.cashiers}</h3>
                        <p className="text-[11px] text-[#9E8B8E] dark:text-[#64748B]">POS & Shift operational</p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div>
                        <p className="text-xs font-bold uppercase tracking-wider text-[#7D6B6E] dark:text-[#94A3B8]">Branch HQs</p>
                        <h3 className="text-2xl font-black text-[#3D2C2E] dark:text-[#F8FAFC] font-mono mt-0.5">{stats.assignedBranches}</h3>
                        <p className="text-[11px] text-[#9E8B8E] dark:text-[#64748B]">Deployed locations</p>
                    </div>
                </motion.div>
            </div>
        </motion.div>
